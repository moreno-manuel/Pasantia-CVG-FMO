            ...
            <form method="POST" action="{{ route('recovery.storeStep3') }}" class="space-y-7">
                ...
                <div class="relative mb-6">
                    <div class="relative flex items-center">
                        ...
                        <input id="password" type="password"
                            class="w-full pl-10 pr-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
                ...
                <div class="relative">
                    ...
                    <input id="password_confirmation" type="password"
                        class="w-full pl-10 px-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
