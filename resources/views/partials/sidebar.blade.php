<aside class="w-64 bg-red-900 text-white h-full flex flex-col">
    <!-- Encabezado con información del usuario -->
    <div class="px-6 py-8 text-center border-b border-red-700">
    ...
    <nav class="flex-1 px-2 py-4 overflow-y-auto">
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('home') }}"
                    class="flex items-center space-x-3 px-6 py-3 hover:bg-yellow-700 rounded group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-300 group-hover:text-red-500"
            ...
            <li>
                <details class="group">
                    <summary
                        class="flex justify-between items-center px-6 py-3 hover:bg-yellow-700 rounded cursor-pointer list-none group-open:ring-2 group-open:ring-red-500">
                        <div class="flex items-center space-x-3">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 text-gray-300 group-hover:text-red-500" fill="none"
    ...
    <div class="px-4 py-4 border-t border-red-700">
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit"
                class="flex items-center space-x-3 w-full text-left px-4 py-2 text-white hover:bg-zinc-500 rounded transition-colors duration-200">
