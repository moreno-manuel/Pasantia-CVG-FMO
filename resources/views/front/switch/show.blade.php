        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="border-t border-gray-200">
                <dl>
                    ...
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-700">Persona Usuario</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $switch['user_person'] }}
                        </dd>
                    </div>
                    ...
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="mt-1 text-sm sm:mt-0 sm:col-span-2">
                            <span
                                ...
                                {{ $switch['status'] === 'Activo' ? 'bg-green-100 text-green-800' : ($switch['status'] === 'Mantenimiento' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800') }}">
                                {{ $switch['status'] }}
                            </span>
                        </dd>
                    </div>
