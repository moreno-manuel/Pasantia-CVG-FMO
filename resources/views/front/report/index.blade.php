...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-white bg-zinc-500 rounded-md px-3 py-1">Reportes</h1>
        </div>
        ...
        <div class="flex flex-col md:flex-row gap-6 w-full">
            <!-- Tabla de reportes -->
            <div class="overflow-hidden rounded-lg shadow border border-gray-700 bg-zinc-600 flex-1 max-w-2xl">
                            ...
                            <tr class="hover:bg-zinc-800 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route($report['url']) }}" target="_blank"
                                        class="inline-flex items-center px-3 py-1.5 bg-red-600 text-white font-semibold text-xs uppercase tracking-widest rounded-md shadow-sm transition-all duration-200 ease-in-out hover:bg-red-800 hover:shadow-md hover:-translate-y-px focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                        Descargar
                                    </a>
                                </td>
                            </tr>
            ...
            @if (auth()->user()->rol == 'admin')
                <div class="overflow-hidden rounded-lg shadow border border-gray-700 bg-zinc-600 flex-1 max-w-xs">
                    <div class="px-6 py-4 bg-red-900">
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="start_date" id="start_date"
                                        class="custom-date-icon mt-1 block w-full bg-zinc-700 border-gray-600 text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
