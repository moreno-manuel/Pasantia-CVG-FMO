                            ...
                            <tr class="hover:bg-gray-900 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-center text-sm">
                                    <span id="status-{{ $camera->mac }}"
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-600 text-red-100">
                                        Inactivo
                                    </span>
                                </td>
                            </tr>
                ...
                fetch("{{ route('test.check') }}")
                    ...
                    .then(data => {
                        ...
                        if (inactiveCameras.length === 0) {
                            tableBody.innerHTML = `
                        <tr>
                            <td colspan="2" class="px-6 py-4 text-center text-sm text-gray-400 italic">
