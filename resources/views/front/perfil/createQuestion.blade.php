    ...
    <div class="container mx-auto px-4 py-6">
        <div class="bg-zinc-600 shadow overflow-hidden sm:rounded-lg p-6 border border-gray-700">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-white">Crear Preguntas de Seguridad</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="question_1" id="question_1"
                            ...
                            @foreach ($questions as $question)
                                <option value="{{ $question }}" {{ old('question_1') == $question ? 'selected' : '' }}>
                                    {{ $question }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select name="question_2" id="question_2"
                            ...
                            <option value="">Seleccione..</option>
                            @foreach ($questions as $question)
                                <option value="{{ $question }}" {{ old('question_2') == $question ? 'selected' : '' }}>
                                    {{ $question }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="question_3" id="question_3"
                            ...
                            @foreach ($questions as $question)
                                <option value="{{ $question }}"
                                    {{ old('question_3') == $question ? 'selected' : '' }}>
                                    {{ $question }}
                                </option>
                            @endforeach
                        </select>
