...
@section('content')
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4" onsubmit="return validateFilters()">
            ...
            {{-- Equipo --}}
            <div>
                <label class="block text-sm font-medium text-black mb-1">Equipo</label>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @foreach ($equipments as $equipment)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center text-sm text-gray-900">{{ $equipment['date'] }}</td>
                                ...
                                <td class="px-6 py-4 text-sm align-middle">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <form action="{{route('eliminated.destroy',$equipment['id'])}}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
    ...
    @push('scripts')
        <script>
            function validateFilters() {
                ...
                const equipments = document.querySelector("select[name='equipments']")?.value.trim();
